...
return (
  <div className="min-h-[100dvh] bg-[#1E2F5D] overflow-x-hidden">
    {/* HEADER AZUL (pinta hasta el status bar) */}
    <div
      className="px-6 pt-[max(16px,env(safe-area-inset-top))] pb-[64px] relative overflow-hidden rounded-b-[22px]"
      style={{
    ...
    {/* SHEET GRIS (sube y “pisa” el azul) */}
    <div className="-mt-[38px] bg-[#F5F5F5] rounded-t-[28px] px-6 pt-[38px] pb-[calc(24px+env(safe-area-inset-bottom)+90px)]">
      {/* Accesos */}
              ...
              <CardShell key={row.id} className="p-4">
                ...
                <div className="mt-4 flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="text-[14px] font-extrabold text-[#1E2F5D]">{price ? price : "Cotización"}</p>
                  </div>
    ...
    {/* FAB publicar (ajustado a safe-area) */}
    <button
      type="button"
      onClick={() => nav("/provider/services/new")}
      className="fixed right-5 bottom-[calc(110px+env(safe-area-inset-bottom))] z-[50] h-14 w-14 rounded-full bg-[#1E2F5D] text-white shadow-[0_14px_30px_rgba(30,47,93,0.35)] grid place-items-center active:scale-[0.98] transition"
