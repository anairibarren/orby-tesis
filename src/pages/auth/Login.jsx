          ...
          <form className="mt-6 flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-2 relative">
                ...
                <input
                  className="w-full rounded-full bg-[#F2F4F7] border border-black/5 pl-12 pr-12 py-3 text-[14px] text-[#3D3D3D] outline-none focus:border-[#1E2F5D] focus:ring-4 focus:ring-[#1E2F5D]/10"
                  value={password}
