// src/pages/provider/Notifications.jsx
...
// ✅ separar "fecha del turno" y "descripción"
...
// ✅ NUEVO: chequeo previo para evitar navegar a pantallas vacías
async function requestExistsForMe(requestId) {
  ...
  if (error) return false; // incluye casos de permisos/RLS
  return !!data?.id;
}
